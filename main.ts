...
function boardDraw(board: string[][]) {
...
async function user(board: string[][], player: string) {
    ...
    function winnerCheck(board: string[][], player: string){
...
async function playGame(){
    ...
    let player : string = "X";                               //yahn pr yahn ko X say denote kia hai
    let winner: boolean = false;                             //yahn say loop start hua hai
